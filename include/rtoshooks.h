...
static const CLI_Command_Definition_t rm_definition = {
    "rm",
    "rm <players|games|*>:\r\n Removes players or games from volatile memory.\r\n\r\n",
    rm_command,
    1
};

BaseType_t clear_command(char *write_buffer, size_t write_buffer_len, const char *command);
