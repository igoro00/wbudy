...
class WbudyRFID {
  ...
  private:
	...
	static constexpr uint8_t ComIEnReg =
		0x02; // Włączanie przerwań komunikacyjnych
	...
	static constexpr uint8_t Status2Reg =
		0x08; // Status odbiornika i transmitera
	static constexpr uint8_t FIFODataReg =
		0x09; // Dane wejściowe/wyjściowe FIFO
	...
	static constexpr uint8_t BitFramingReg =
		0x0D; // Orientacja bitów dla transmisji i odbioru
